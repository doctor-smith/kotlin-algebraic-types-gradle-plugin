...
fun usesPlugin(): String = """
    |// Generated by the kotlin-algebraic-types-plugin. DO NOT EDIT!
    |// url: https://github.com/doctor-smith/kotlin-algebraic-types-plugin
    |// developer: Dr. Florian Schmidt
    |// email: schmidt@alpha-structure.com
""".trimMargin()
...
fun String.productsPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.product)
...
fun String.sumsPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.sum)
...
fun String.dualityPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.duality)
...
fun String.evoleqSumPackage() = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.evoleqSum)
...
fun String.evoleqProductPackage() = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.evoleqProduct)
...
fun String.lensPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.lens)
...
fun String.prismPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.prism)
...
fun String.annotationPackage(): String = when {
    endsWith(TypePackage.key) -> replaceLast(TypePackage.key, TypePackage.annotation)
...
fun String.keysPackage(): String = when {
    endsWith(TypePackage.annotation) -> replaceLast(TypePackage.annotation, TypePackage.key)
    endsWith(TypePackage.prism) -> replaceLast(TypePackage.prism, TypePackage.key)
    endsWith(TypePackage.product) -> replaceLast(TypePackage.product, TypePackage.key)
    endsWith(TypePackage.duality) -> replaceLast(TypePackage.duality, TypePackage.key)
    endsWith(TypePackage.evoleqSum) -> replaceLast(TypePackage.evoleqSum, TypePackage.key)
    endsWith(TypePackage.evoleqProduct) -> replaceLast(TypePackage.evoleqProduct, TypePackage.key)
    endsWith(TypePackage.lens) -> replaceLast(TypePackage.lens, TypePackage.key)
    endsWith(TypePackage.sum) -> replaceLast(TypePackage.sum, TypePackage.key)
    endsWith(TypePackage.key) -> this
    equals("") -> TypePackage.key
    else -> this + "." +TypePackage.key
}
